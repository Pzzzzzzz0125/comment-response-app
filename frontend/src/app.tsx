  ...
  return <div className="min-h-screen bg-background text-foreground">
    <header className="sticky top-0 z-30 border-b bg-background/95 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-[1680px] items-center gap-4 px-4 sm:px-6">
        ...
        <Tooltip><TooltipTrigger asChild><Button variant="outline" size="sm" onClick={() => setWorkbookReviewOpen(true)}><FileSpreadsheet /><span className="hidden lg:inline">Review workbooks</span>{workbookReviewCount !== null && <Badge className={workbookReviewCount ? "border-amber-200 bg-amber-50 text-amber-900" : ""} variant="secondary">{workbookReviewCount}</Badge>}</Button></TooltipTrigger><TooltipContent>Verify structured spreadsheet imports without Gemini</TooltipContent></Tooltip>
