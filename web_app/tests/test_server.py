...
class SourceViewerTests(unittest.TestCase):
    ...
    def test_preview_is_inline_and_only_original_is_attachment(self):
        ...
        original = self.registry.delivery(pdf["document_id"], "original")
        self.assertEqual(preview["disposition"], "inline")
        self.assertEqual(preview["status"], 206)
        self.assertEqual(original["disposition"], "attachment")
